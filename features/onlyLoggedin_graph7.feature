Feature: onlyLoggedin_graph7
  ...
  Only logged in users should be able to see the Statistical View link
    ...
    Given I am a visitor to choose four countries and three subjects
    ...
    Then I should click on the Search button for four countries and three subjects
