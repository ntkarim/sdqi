Feature: onlyLoggedin_table4
  ...
  Only logged in users should be able to see the Statistical View link
    ...
    Given I am a visitor to choose two countries and three subjects
    ...
    Then I should click on the Search button for two countries and three subjects
