Feature: onlyLoggedin_graph3
  ...
  Only logged in users should be able to see the Statistical View link
    ...
    Given I am a visitor to choose two countries and two subjects
    ...
    Then I should click on the Search button for two countries and two subjects
