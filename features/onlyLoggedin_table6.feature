Feature: onlyLoggedin_table6
  ...
  Only logged in users should be able to see the Statistical View link
    ...
    Given I am a visitor to choose three countries and two subjects
    ...
    Then I should click on the Search button for three countries and two subjects
