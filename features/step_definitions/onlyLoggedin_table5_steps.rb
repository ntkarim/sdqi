Given(/^I am a visitor to choose three countries and three subjects$/) do
...
Then(/^I should click on the Search button for three countries and three subjects$/) do
