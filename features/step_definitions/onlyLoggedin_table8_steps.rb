Given(/^I am a visitor to choose four countries and four subjects$/) do
  ...
  @record12 = FactoryGirl.create(:country_data12)
  @record13 = FactoryGirl.create(:country_data13)
  @record14 = FactoryGirl.create(:country_data14)
  @record15 = FactoryGirl.create(:country_data15)
end

Then(/^I should click on the Search button for four countries and four subjects$/) do
  ...
  find(:css, "#subject_list_subject_name_employment[value='Employment']").set(true)
  click_button 'Search'
end
